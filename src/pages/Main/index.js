    ...
    <Container style={{ maxWidth: 680, minHeight: "100vh", paddingTop:'30px' }}>
      <Box sx={{ marginBottom: "2rem" }}>
        <Grid container alignItems="center" flexDirection="column">
          ...
          <Box className={classes.wrapName}>
            <h1 className={classes.name}><b>HÒA HƯỜNG</b></h1>
          </Box>
          <Box className={classes.desc}>
            <h5 style={{ margin: 0 }}><i>CHUYÊN THỜI TRANG NAM CAO CẤP</i></h5>
          </Box>
        </Grid>
      </Box>
      <Box>
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="https://zalo.me/84966251777">Zalo</Link>
            </Grid>
          </CardContent>
        </Card>
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="https://www.facebook.com/profile.php?id=100069681443135">Facebook</Link>
            </Grid>
          </CardContent>
        </Card>
        {/* <Card className={classes.card}>
        ...
        {/* <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} href="mailto:dungdv95.bg@gmail.com">Email</Link>
            </Grid>
          </CardContent>
        </Card> */}
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="tel:+84966251777">Phone number</Link>
            </Grid>
          </CardContent>
        </Card>
      </Box>
      <Box sx={{ marginTop: "4rem" }}>
        <Grid container alignItems="center" flexDirection="column">
          ...
          <Box className={classes.desc}>
            <h2 style={{ font: "inherit", margin: 0 }}>Tên Chủ Thẻ : Dương Văn Hòa</h2>
          </Box>
          <Box className={classes.desc}>
